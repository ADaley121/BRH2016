...
exports.create_piecetype = function(gsid,n,nw,w,sw,s,se,e,ne,icon,isKing,callback) {
  // make piecetype and give pt through callback
  var piecetype = { gamestateid: gid,
                    movement_n: n, 
                    movement_nw: nw,
                    movement_w: w,
                    movement_sw: sw,
...
exports.create_piece = function(gsid,ptid,x,y,plid,callback) {
...
exports.get_gamestate = function(gsid, callback) {
  // poll gamestate
...
exports.get_pieces = function(gsid, callback) {
...
exports.get_piecetypes = function(gsid, callback) {
  // get the pieces corresponding to gid
  con.query('SELECT * FROM piecetype WHERE gamestateid = ?', [gid], function(err, piecetypes) {
    if (err) throw err;
    callback(piecetypes);
  });
}
...
exports.create_game = function (gsid,plid,callback) {
...
exports.get_game = function(gid,callback) {
...
exports.join_game = function(gid,plid,callback) {
